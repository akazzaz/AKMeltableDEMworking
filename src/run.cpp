...
//		if(choice=="SHEAR_WORK"){config.cell.shear_work_control=true; cin>>config.cell.shear_work_input;}
	...
	get_secure("Do you want to simule the melt surface tension", "SURFACE_TENSION",	config.parameter.simule_melt_surface_tension);
	if (config.parameter.simule_melt_surface_tension){
